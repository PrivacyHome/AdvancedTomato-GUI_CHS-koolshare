...
<content>
    ...
    <script type="text/javascript">
        ...
        function watchdogReset() {
            if (wdog) clearTimeout(wdog) wdog = setTimeout(watchdog, 5000 * updateInt);
    ...
    <div id="cstats" class="box">
        <div class="heading">
            实时IP流量监控 &nbsp;
            <div class="spinner" id="refresh-spinner" onclick="javascript:debugTime=1">
            </div>
        </div>
        <div class="content">
            ...
            <div id="bwm-controls">
                ...
                |
                <a class="ajaxload" href="admin-iptraffic.asp">
                    <b>
                        配置
                    </b>
                </a>
            ...
            <table id="txt" class="data-table bwm-info">
                <tr>
                    <td>
                        <b style="border-bottom:blue 2px solid" id="rx-name">
                            下行
                        </b>
                ...
                <tr>
                    <td>
                        <b style="border-bottom:blue 2px solid" id="tx-name">
                            上行
                        </b>
            ...
            <span id="dtime" style="display:none;">
            </span>
            <div class="alert alert-warning" id="warnwd" style="display:none">
                警告：10秒超时，重新启动...&nbsp;
            </div>
        </div>
    </div>
