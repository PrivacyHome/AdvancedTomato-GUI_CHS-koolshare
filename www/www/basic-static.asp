...
Enhancements by Teaman Copyright (C) 2011 Augusto Bott http://code.google.com/p/tomato-sdhc-vlan/
...
<content>
    <script type="text/javascript">
        ...
        sg.verifyFields = function(row, quiet) {
            ...
            if (f[3].value.indexOf('.') == -1) {
                s = parseInt(f[3].value, 10) if (isNaN(s) || (s <= 0) || (s >= 255)) {
        ...
        sg.setup = function() {
            ...
            for (var i = 0; i < s.length; ++i) {
                ...
                if ((t.length == 3) || (t.length == 4)) {
                    ...
                    this.insertData( - 1, [d[0], (d.length >= 2) ? d[1] : '00:00:00:00:00:00', t[3], (t[1].indexOf('.') == -1) ? (ipp + t[1]) : t[1], h, t[2]]);
                }
            }
            this.sort(4);
            this.showNewEditor();
    ...
    <form id="_fom" method="post" action="tomato.cgi">
        ...
        <div class="box">
            <div class="heading">
                局域网：静态DHCP分配、ARP绑定、带宽监控
            </div>
            <div class="content">
                <table class="line-table" id="bs-grid">
                </table>
                <br />
                <h3>
                ...
                <script type="text/javascript">
                    $('#sesdivoptions').forms([{
                        title: '忽略来自未知设备的DHCP请求',
                        name: 'f_dhcpd_static_only',
                        type: 'checkbox',
                        value: nvram.dhcpd_static_only == '1'
                    }]);
                </script>
                <h4>
                    说明
                ...
                <div class="section" id="sesdivnotes" style="display:none">
                    <ul>
                        <li>
                            ...
                            - 与此特定设备上的网络接口相关联的唯一标识符.
                        </li>
                        <li>
                            <b>
                                绑定到
                            </b>
                            - 强制执行此特定IP / MAC地址对应的静态ARP绑定.
                        </li>
                        <li>
                            <b>
                                IP地址
                    ...
                    <ul>
                        <li>
                            ...
                            - 对上面列出的所有IP / MAC地址执行静态ARP绑定.
                        </li>
                        <li>
                            <b>
                                忽略DHCP请求 (...)
                            </b>
                            - 未列出的MAC地址不能通过DHCP获取IP地址.
                        </li>
                    </ul>
                    <ul>
                        <li>
                            ...
                            <ul>
                                <li>
                                    要为设备指定多个主机名，请使用空格分隔它们.
                                </li>
                                <li>
                                    要为特定设备启用/实施静态ARP绑定，它必须只有一个MAC与该特定IP地址相关联（即，您不能有两个MAC地址链接到上表中的相同主机名/设备）.
                                </li>
                                <li>
                                    当为特定MAC / IP地址对启用ARP绑定时，该设备将始终在LAN唤醒表中显示为“活动”。
                                    <a href="#tools-wol.asp">
                                        点我查看在线列表
                                    </a>
                                </li>
                                <li>
